...
#define TOS                 11
    ...
    {
    //RESET
        PORT02_IOCR0 &= ~((0x1F) << PC1); //D3 스위치 2 리셋 (0001 1111)
        PORT02_IOCR0 &= ~((0x1F) << PC0); //D2 스위치 1 리셋 (0001 1111)
    //SET
        PORT02_IOCR0 |=  ((0x2) << PC1); //D3 스위치 2번 ON (0000 0010)
        PORT02_IOCR0 |=  ((0x1) << PC0); //D2 스위치 1번 ON (0000 0010)
    }
