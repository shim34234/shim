...
Libraries/iLLD/TC27D/Tricore/Mtu/Std/%.src: ../Libraries/iLLD/TC27D/Tricore/Mtu/Std/%.c Libraries/iLLD/TC27D/Tricore/Mtu/Std/subdir.mk
	...
	cctc -D__CPU__=tc27xd "-fC:/RESKILL/002_tc275_gpo_led_switch/Debug/TASKING_C_C___Compiler-Include_paths.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc27xd -o "$@"  "$<"  -cs --dep-file="$(@:.src=.d)" --misrac-version=2012 -N0 -Z0 -Y0 2>&1;
