...
#define SEL7                         14
#define GTM_TOUTSEL6                 (*(volatile unsigned int*)(GTM_BASE + 0x9FD48)) //TOUT104 에 연결을 하려면, TOUT6, SEL8 선정 필요
#define SEL8                         15
...
#define UPEN_CTRL1                   18     //TOM0-CH1 shadow 기능, 10으로
#define UPEN_CTRL7                   30     //TOM0-CH15용 shadow 기눙, 10으로
...
#define ENDIS_CTRL7                  14     //TOM CHANNEL 1 업데이트
...
#define GTM_TOM0_CH15_CTRL           (*(volatile unsigned int*)(GTM_BASE + 0x08540)) //15번이 안될수도 있음
#define SL                           11     //polarity
#define CLK_SRC_SR                   12     //클럭 주파수 변경 1 (1/8)

#define GTM_TOM0_CH1_SR0             (*(volatile unsigned int*)(GTM_BASE + 0x08044))
#define GTM_TOM0_CH15_SR0            (*(volatile unsigned int*)(GTM_BASE + 0x08544))
#define SR0                          0      //compare shadow register (ccu0)

#define GTM_TOM0_CH1_SR1             (*(volatile unsigned int*)(GTM_BASE + 0x08048))
#define GTM_TOM0_CH15_SR1            (*(volatile unsigned int*)(GTM_BASE + 0x08548))
#define SR1                          0      //compare shadow register (ccu1)
...
void init_LED(void)
    ...
    //SET
        PORT10_IOCR0 |=  ((0x11) << PC1); //LED2 ON (0001 0000) / PWM 쓰려면 0x11 (0001 0001) (T103)
        PORT10_IOCR0 |=  ((0x11) << PC2); //LED1 ON (0001 0000) / PWM 쓰려면 0x11   (T104)
    }
...
//SET PC1 PC2
    PORT02_IOCR4 |= ((0x11) << PC7); //불 on,off 0x10 , PWM 0x11 (TOUT4=7) TOM0.15
    PORT10_IOCR4 |= ((0x11) << PC5); // (T107)   TOM0.2
    PORT10_IOCR0 |= ((0x11) << PC3); // (T109)   TOM0.3
}
...
void init_GTM_TOM0_PWM(void)
{
    ...
    //
        ...
        while ((GTM_CLC & ( 1 << DISS)) != 0); //모듈이 사용 가능해 질때 사용 할 수 있도록. 0이 들어와야 작동됨
...
//GTM TOM0 PWM SETTING (P10.1)
        ...
        GTM_TOM0_CH1_SR1  = 1000;
        //GTM_TOM0_CH1_SR1  = 6250 - 1;
...
//GTM TOM0 PWM SETTING (P2.7)
        ...
        GTM_TOM0_CH15_SR1  = 1000;
        //GTM_TOM0_CH15_SR1  = 6250 - 1;
